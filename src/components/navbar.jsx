...
export default class Nav extends Component {
  ...
  render() {
    return (
      <div
        className="full-navbar-div opacity-0 flex bg-accent4 top-0 lg:bg-main justify-between">
        <div
          className='name-div text-gray-400 py-2 px-3 items-center text-3xl md:text-4xl lg:hidden'>
          <div>
          <h1>Emira Hajj</h1>
          </div>
        </div>
        <div className="icon-div flex flex-row  lg:flex-col-reverse lg:fixed lg:right-0">
          <a href="https://github.com/emirahajj">
            <svg
              class="fill-current text-accent1 w-6 md:w-8 md:mt-3 mt-4 hover:text-white lg:w-10  mr-4"
              id="Layer_1"
              data-name="Layer 1"
          ...
          <a href="https://www.linkedin.com/in/emirahajj/">
            <svg
              className="fill-current text-accent1 w-6 md:w-8 md:mt-3 mt-4 lg:w-10 hover:text-white mr-4"
              id="Layer_1"
              data-name="Layer 1"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24">
          ...
          <a href="https://www.instagram.com/emira.hpp/">
            <svg
              class="fill-current text-accent1 w-6 md:w-8 md:mt-3 mt-4 lg:w-10   hover:text-white mr-4"
              id="Layer_1"
              data-name="Layer 1"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24">
          ...
          <a href="emira_hajj.pdf">
            <svg
              class="fill-current text-accent1 w-6 md:w-8 md:mt-3 hover:text-white  lg:w-10 mt-4 -ml-1 lg:ml-0 mr-4"
              id="Capa_1"

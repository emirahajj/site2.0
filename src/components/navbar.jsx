...
export default class Nav extends Component {
  ...
  render() {
    return (
      <div
        className="full-navbar-div opacity-0 flex bg-transparent top-0 lg:bg-main justify-between">
        {/* <div className="fixed z-0 w-full">
          <svg
            ...
            <path
              class="stnav"
              d="M0,0v76c116.6,0,200.4,19,317,19c246.3,0,337.7-30,584-30c168.4,0,513.6,30,682,30c108.5,0,227.5-19,336-19
	c0-25.3,0-50.7,0-76H0z"/>
          </svg>
        </div> */}
        <div
